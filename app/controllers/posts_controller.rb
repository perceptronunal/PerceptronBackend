class PostsController < ApplicationController
  ...
  def create
    if @organization != nil
      ...
      if @post.save
        render json: @post, status: :created, location: @post, serializer: PostAllSerializer, include: include: ['organization', 'organization.resources', 'resources','comments.user']
      else
